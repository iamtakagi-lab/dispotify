...
export const DeleteAccountButton: React.VFC<{}> = () => {
  ...
  return (
    <>
      <button
        className="h-8 px-4 m-2 text-sm text-red-100 transition-colors duration-150 bg-red-700 rounded-lg focus:shadow-outline hover:bg-red-800"
        onClick={() => {
          setShowModal(true)
        }}
      >
